        ...
        <div className="flex flex-col items-center justify-center min-h-screen">
            <div className="max-w-md w-full px-6 py-8 shadow-md rounded-lg">
                ...
                <form className="space-y-7">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="text-sm">
                            <a href="#" className="font-sans font-medium text-md text-[rgb(24,204,216)] hover:text-[rgb(10,131,139)]">
                                Forgot your password?
                            </a>
                        </div>
                    </div>
                    <div>
                        <button type="submit" className=" font-sans w-full flex justify-center py-2 px-4 border border-transparent rounded-lg shadow-sm text-sm font-bold text-black bg-[rgb(24,204,216)] hover:bg-[rgb(10,131,139)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            Sign in
                        </button>
                    </div>
                    <div className="flex items-center justify-center">
                        <span className="text-md text-white mr-2 font-sans">Or sign in with</span>
                ...
                <div className="mt-4 text-center text-sm">
                    <span className="text-white font-sans">Don't have an account? </span>
                    <a href="/SignUpPage" className="font-semibold font-sans text-[rgb(239,104,8)] hover:text-[rgb(155,71,10)] text-md">
                        Register
                    </a>
                </div>
            </div>
